...
fix16_t fix16_from_string(const char * const s);
...
static inline fix16_t fix16_square(fix16_t a) { return fix16_smul(a,a); }
static inline fix16_t fix16_vec_mod(fix16_t x,fix16_t y){return fix16_sqrt(fix16_add(fix16_smul(x, x), fix16_smul(y, y))); }
